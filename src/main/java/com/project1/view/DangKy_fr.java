 ...
 * @author vanng
 */
public class DangKy_fr extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DangKy_fr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
